...
class DefaultFiltersTests():
    def test_floatformat(self):
        ...
        create_test(set_args('floatformat', pos_inf), unicode(pos_inf))

        neg_inf = float(-1e30000)
        create_test(set_args('floatformat', neg_inf), unicode(neg_inf))

        nan = pos_inf / pos_inf
        create_test(set_args('floatformat', nan), unicode(nan))
